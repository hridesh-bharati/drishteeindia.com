function change() {
    "black" === MyBodyColor.style.backgroundColor
...
function AdmChange() {
    "black" === AdmBodyColor.style.backgroundColor
...
function aboutBgChanger() {
    "black" === AboutBackground.style.backgroundColor
...
function BranchBgChanger() {
    "black" === BranchBgColor.style.backgroundColor
...
function DiplomaBgChanger() {
    "black" === DiplomaBody.style.backgroundColor
...
function LanguageChanger() {
    "black" === LanguageBodyColor.style.backgroundColor
...
function graphicsBgChanger() {
    "black" == TopNavBar.style.backgroundColor
        ? ((TopNavBar.style.backgroundColor = "var(--darkRed)"),
            (CourseListNav.style.backgroundColor = "var(--darkRed)"),
            (studentZoneNav.style.backgroundColor = "var(--darkRed)"),
...
function RepairingChanger() {
    "black" === RepairingBody.style.backgroundColor
...
function resultBody() {
    "black" === VerificationBody.style.backgroundColor
        ? ((TopNavBar.style.backgroundColor = "var(--darkRed)"),
            (TopNavBar.style.border = "transparent"),
            (CourseListNav.style.backgroundColor = "var(--darkRed)"),
            (studentZoneNav.style.backgroundColor = "var(--darkRed)"),
...
function ContactChanger() {
    "black" === MainContactBgColor.style.backgroundColor
...
document.onkeydown = function (e) {
    return (
        !e.ctrlKey ||
        (67 !== e.keyCode && 97 !== e.keyCode && 65 !== e.keyCode && 99 !== e.keyCode && 86 !== e.keyCode && 83 !== e.keyCode && 115 !== e.keyCode && 85 !== e.keyCode && 105 !== e.keyCode && 73 !== e.keyCode && 117 !== e.keyCode) ||
        alert("Not allowed"),
        !1
    );
};
...
function printData() {
    var body = document.getElementById("VerificationBody").innerHTML,
        PrintResult = document.getElementById("PrintResult").innerHTML;
    (document.getElementById("VerificationBody").innerHTML = PrintResult), window.print(), (document.getElementById("VerificationBody").innerHTML = body), html2pdf().from(PrintResult);
}
function DownloadData() {
    var PrintResult = document.getElementById("PrintResult").innerHTML;
    (document.getElementById("VerificationBody").innerHTML = PrintResult), html2pdf().from(PrintResult).save();
}
...
function checkMark() {
    checkBtn.disabled ? (document.getElementById("checkBtn").disabled = !1) : (document.getElementById("checkBtn").disabled = !0);
}
